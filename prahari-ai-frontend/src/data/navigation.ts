...
export const navigation = [
    ...
    { name: "Live Incidents", labelKey: "navIncidents", icon: AlertTriangle, path: "/incidents", level: 1 },
    ...
    { name: "Settings", labelKey: "settings", icon: Settings, path: "/settings", level: 1 },
